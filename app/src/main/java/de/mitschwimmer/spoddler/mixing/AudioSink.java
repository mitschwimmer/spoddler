...
import de.mitschwimmer.spoddler.Player;
...
import de.mitschwimmer.spoddler.soundadapter.FloatControl;
...
public final class AudioSink implements Runnable, Closeable {
    ...
    /**
     * Pauses the sink and then releases the Line if specified by {@param release}.
     */
